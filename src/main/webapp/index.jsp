...
<div class="main-container">
    ...
    <label class = "color-picker-label" >
        <span class ="aa"></span>
        <input type="radio" name="order" id="zfb" value="zfb" class="radioStyle imgInput" onclick="showWhichOrder(this.id)">
        <span class="zfbclick"><img src="static/img/Alipay.jpg"></span>
    </label>
    <label class = "progress-label" >
        <span class ="aa"></span>
        <input type="radio" name="order" id="union" value="union" class="radioStyle imgInput" onclick="showWhichOrder(this.id);">
        <span class="ylclick"><img src="static/img/UnionPay.jpg">  </span>
    </label>

    <br>
    <button id="btnSubmitOrder" type="button" onsubmit="showWhichOrder(document.getElementById())">支付</button>
    <br>
    <br>
    <br>
    <div>支付宝支付</div>
